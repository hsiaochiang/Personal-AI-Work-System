...
Define the canonical V3 conversation schema so every adapter can normalize tool-specific conversation data into one shared contract before entering the extraction pipeline.
