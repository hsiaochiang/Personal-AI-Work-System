...
Define repository requirements for V1 Phase 3 real-project validation, ensuring authentic inputs, two end-to-end validation runs, measurable candidate utility, complete dedupe conflict resolution, non-regression against S2 scope, and governance evidence synchronization.
