...
Allow `/extract` to ingest ChatGPT share transcripts and official conversation JSON exports through a minimal adapter-based flow, while preserving the existing plain-text fallback and extraction pipeline.
