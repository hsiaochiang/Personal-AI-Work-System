...
Define S6 multi-tool integration MVP requirements so at least two tool sources can be ingested, normalized, reviewed with a mandatory human gate, and written back only to draft evidence while keeping governance artifacts synchronized.
