...
Define the minimum repository requirements for a single complete, real, manual Phase 1 workflow pilot using the governance entrypoints and OpenSpec lifecycle.
