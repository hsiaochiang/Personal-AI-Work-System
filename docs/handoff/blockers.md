...
## Resolved Blockers
- 2026-04-15：`memory-ai-curator` 已完成 main spec sync（`openspec/specs/memory-ai-curator/spec.md`）與 archive（`openspec/changes/archive/2026-04-15-memory-ai-curator/`），V6 active change 已解除
