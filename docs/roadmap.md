...
- **V3 Change 6 `import-ui-multi-source`** 已完成 archive（2026-04-04）；`/extract` 的多來源匯入入口、來源 badge 與 main spec sync 全數收尾完成。
- 下一優先：處理 template verify 缺少 `.github/prompts/openspec-execute.prompt.md` 的 blocker，並開始 V4 治理自動化規劃。
