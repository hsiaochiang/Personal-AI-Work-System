...
| **V5** | 外部 API 整合與多工具擴充層 | 以 Gemini / Claude 半自動 adapter 補齊工具覆蓋；透過 ChatGPT API key 自動抓取對話，讓知識匯入更完整 | Gemini/Claude adapter + ChatGPT API auto-import | ⏳ 未開始 |
...
- **下一步：確認 `docs/planning/v5-brief.md`（填入確認日期），解除 V5 開工前置條件**
