# Codex Review Gate — plain-text-adapter-refactor

> 本檔案為 v3 brief 確認後自動生成（確認日期：2026/4/2）。Executor 完成後，開新 Codex session 並貼入以啟動 Review Gate 角色。

Read AGENTS.md first.
Then read CODEX.md (Codex 導覽補充).
...
Read docs/planning/v3-brief.md.
